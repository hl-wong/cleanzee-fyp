...
import { createAdvertisement } from "../../../services";
...
interface NewAdvertisementScreenProps {
  navigation: any;
}

const NewAdvertisementScreen: React.FC<NewAdvertisementScreenProps> = ({
  navigation,
}) => {
  ...
  return (
    <Layout headerTitle="New Advertisement" onBack={() => goBack(navigation)}>
...
export default NewAdvertisementScreen;
